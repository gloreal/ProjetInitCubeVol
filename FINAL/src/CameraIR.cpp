...
CameraIR::CameraIR() {
    this->address = 0x69;
    //Mesure *mesure1 = new Mesure(12.5);
    //mesure1->setDateHour("2019/11/12 12:12:12");
    //this->listedemesures.push_back(mesure1);
    //Mesure *mesure2 = new Mesure(-14.5);
    //mesure2->setDateHour("2019/11/12 12:22:12");
    //   this->listedemesures.push_back(mesure2);
    //Mesure *mesure3 = new Mesure(16.5);
    //mesure3->setDateHour("2019/11/12 12:32:12");
    //   this->listedemesures.push_back(mesure3);
    //Mesure *mesure4 = new Mesure(18.5);
    //mesure4->setDateHour("2019/11/12 12:42:12");
    //   this->listedemesures.push_back(mesure4);
}
